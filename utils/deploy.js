...
module.exports = id => {
  ...
  const commandsHash = crypto
    ...
    .digest('hex')
  if (!fs.existsSync('./databases/commandsHash.txt'))
    fs.writeFileSync('./databases/commandsHash.txt', '')
  if (fs.readFileSync('./databases/commandsHash.txt', 'utf-8') === commandsHash)
    return
